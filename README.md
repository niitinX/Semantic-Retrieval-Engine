# Semantic Retrieval Engine | Python, FastAPI, Ollama, HNSW, RAG

A Python FastAPI-based semantic search and Retrieval-Augmented Generation (RAG) platform supporting vector search, document ingestion, local LLM integration through Ollama, and multiple nearest-neighbor retrieval strategies.
...
Notes
- The Python implementation includes Brute Force, KD-Tree, and a simplified HNSW-style search layer for learning and experimentation.
- RAG features call a local Ollama instance. Install Ollama and pull models:
  - `ollama pull nomic-embed-text`
  - `ollama pull llama3.2`
# VectorDB — Build a Vector Database from Scratch in Python

A fully working **Vector Database** built from scratch in Pyhton with a web UI.  
...
```powershell
git clone https://github.com/YOUR_USERNAME/Semantic-Retrieval-Engine.git
...
Then update the generation model name in `main.py`:
```cpp
gen_model = "llama3.2:1b";   // change this
```
